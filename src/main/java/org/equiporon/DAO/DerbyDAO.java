...
/**
 * Clase DAO para gestionar operaciones CRUD en la base de datos Apache Derby
...
public class DerbyDAO {
    ...
    /**
     * Constructor que recibe la conexión a la base de datos Derby.
     *
    ...
    public void aniadir(String id, String nombre, String apellidos, String curso, String patronus) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            System.err.println("Error al añadir estudiante en Derby: " + e.getMessage());
        }
    }
    ...
    public void editar(String id, String nombre, String apellidos, String curso, String patronus) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            System.err.println("Error al editar estudiante en Derby: " + e.getMessage());
        }
    }
    ...
    public void borrar(String id) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            System.err.println("Error al borrar estudiante en Derby: " + e.getMessage());
        }
    }
}
